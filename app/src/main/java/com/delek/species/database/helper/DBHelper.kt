...
class DBHelper(context: Context?) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL(PlanetTypesHelper.SQL_CREATE_ENTRIES)
        db?.execSQL(BuildHelper.SQL_CREATE_ENTRIES)
        db?.execSQL(DeviceHelper.SQL_CREATE_ENTRIES)
        db?.execSQL(DeviceTypesHelper.SQL_CREATE_ENTRIES)
    ...
    override fun onUpgrade(db: SQLiteDatabase?, p1: Int, p2: Int) {
        ...
        db?.execSQL(PlanetTypesHelper.SQL_DELETE_ENTRIES)
        db?.execSQL(BuildHelper.SQL_DELETE_ENTRIES)
        db?.execSQL(DeviceHelper.SQL_DELETE_ENTRIES)
        db?.execSQL(DeviceTypesHelper.SQL_DELETE_ENTRIES)
